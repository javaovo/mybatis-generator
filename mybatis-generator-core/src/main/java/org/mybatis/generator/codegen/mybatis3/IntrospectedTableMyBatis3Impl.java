...
import org.mybatis.generator.codegen.mybatis3.javamapper.JavaControllerGenerator;
...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
	...
	protected void calculateJavaServiceGenerators(List<String> warnings, ProgressCallback progressCallback) {
		...
		if (getRules().generateJavaServiceImpl()) {
