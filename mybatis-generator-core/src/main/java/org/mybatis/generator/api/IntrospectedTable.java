...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		ATTR_DAO_IMPLEMENTATION_TYPE, ATTR_DAO_INTERFACE_TYPE, ATTR_SERVICE_IMPLEMENTATION_TYPE, // 自定义ServiceImpl
		ATTR_SERVICE_INTERFACE_TYPE, // 自定义Service
		ATTR_CONTROLLER_TYPE, // 自定义Controller
		ATTR_PRIMARY_KEY_TYPE, ATTR_BASE_RECORD_TYPE, ATTR_RECORD_WITH_BLOBS_TYPE, ATTR_EXAMPLE_TYPE, ATTR_IBATIS2_SQL_MAP_PACKAGE, ATTR_IBATIS2_SQL_MAP_FILE_NAME,
		...
		ATTR_COUNT_BY_EXAMPLE_STATEMENT_ID, ATTR_DELETE_BY_EXAMPLE_STATEMENT_ID, ATTR_DELETE_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_INSERT_STATEMENT_ID,
		ATTR_INSERT_SELECTIVE_STATEMENT_ID, ATTR_SELECT_ALL_STATEMENT_ID, ATTR_SELECT_BY_EXAMPLE_STATEMENT_ID, ATTR_SELECT_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID,
		ATTR_SELECT_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_UPDATE_BY_EXAMPLE_STATEMENT_ID, ATTR_UPDATE_BY_EXAMPLE_SELECTIVE_STATEMENT_ID,
		ATTR_UPDATE_BY_EXAMPLE_WITH_BLOBS_STATEMENT_ID, ATTR_UPDATE_BY_PRIMARY_KEY_STATEMENT_ID, ATTR_UPDATE_BY_PRIMARY_KEY_SELECTIVE_STATEMENT_ID,
		ATTR_UPDATE_BY_PRIMARY_KEY_WITH_BLOBS_STATEMENT_ID, ATTR_BASE_RESULT_MAP_ID, ATTR_RESULT_MAP_WITH_BLOBS_ID, ATTR_EXAMPLE_WHERE_CLAUSE_ID,
		ATTR_BASE_COLUMN_LIST_ID, ATTR_BLOB_COLUMN_LIST_ID, ATTR_MYBATIS3_UPDATE_BY_EXAMPLE_WHERE_CLAUSE_ID, ATTR_MYBATIS3_SQL_PROVIDER_TYPE,
	 ...
	 */
	public void setControllerInterfaceType(String type) {
		internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_TYPE, type);
	}
	 ...
	 * 自定义
	 * 
	 * @param ControllerInterfaceType
	 */
	public String getControllerInterfaceType() {
	...
	public void initialize() {
		...
		calculateJavaServiceAttributes(); // 自定义
		calculateJavaControllerAttributes();// 自定义
	...
	protected void calculateJavaControllerAttributes() {
		...
		setControllerInterfaceType(sb.toString());
	}
